...
aic_val  <- AIC(mod_lmm)
bic_val  <- BIC(mod_lmm)
r2_vals  <- performance::r2_nakagawa(mod_lmm)  # marginal and conditional R²
icc_val  <- performance::icc(mod_lmm)          # intraclass correlation

cat("\nGoodness-of-fit metrics:\n",
    "AIC =", aic_val, "\n",
    "BIC =", bic_val, "\n",
    "Marginal R² =", r2_vals$R2_marginal, "\n",
    "Conditional R² =", r2_vals$R2_conditional, "\n",
